...
public class AddContactActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvView = (TextView) findViewById(R.id.notFind);
	}
	...
	public void searchContact(View v) {
		...
		try {
			...
			executeRequest(new GsonRequest<User>(path,User.class,findUserListener(),errorListener()));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private Response.Listener<User> findUserListener() {
