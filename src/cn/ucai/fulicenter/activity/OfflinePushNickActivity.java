...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.ucai.fulicenter.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.ucai.fulicenter.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.ucai.fulicenter.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.ucai.fulicenter.R.id.tv_nickname_description);
