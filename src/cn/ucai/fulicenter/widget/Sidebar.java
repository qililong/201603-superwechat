...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.ucai.fulicenter.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.ucai.fulicenter.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.ucai.fulicenter.R.drawable.sidebar_background_pressed);
			return true;
		}
